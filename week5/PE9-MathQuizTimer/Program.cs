...
namespace PE9_MathQuizTimer
{
    static class Program
    {
        ...
        static void Main()
        {
            //stores whether player answered in time
            bool bInTime = true;
        ...
        start:
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                do
                {
                    ...
                    //if user is quick enough stop the input taker
                    timer.Stop();
                ...
                else if (!bInTime)
                {
                    ...
                    Console.WriteLine("I'm sorry {0}.You took too long!", myName);
                }
                else
                {
                    Console.BackgroundColor = ConsoleColor.Black;
