...
namespace MDI_GifFinder
{
    public partial class GifFinder : Form
    {
        ...
        private void TileToolStripMenuItem__Click(object sener, EventArgs e)
        {
            this.LayoutMdi(MdiLayout.TileHorizontal);
        }

        private void CascadeToolStripMenuItem__Click(object sener, EventArgs e)
        {
            this.LayoutMdi(MdiLayout.Cascade);
        }

        private void ExitToolStripMenuItem__Click(object sener, EventArgs e)
        {
            Application.Exit();
        }

        private void NewSearchToolStripMenuItem__Click(object sener, EventArgs e)
        {
        ...
        private void Timer1__Tick(object sender, EventArgs e)
        {
            ...
            if ( htmlElement != null )
            {
                ...
                htmlElementCollection = webBrowser1.Document.GetElementsByTagName("image");
