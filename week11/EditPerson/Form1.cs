...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
            ...
            Important Fields in EventArgs
                None.
            */
            // class checkChanged Event Handlers
            ...
            // set initial class value if the person is a student
            if (formPerson is Student)
            {
                Student student = (Student)formPerson;
            ...
            if (person.name == null)
            {
                ...
                formPerson.eGender = genderPronoun.them;
            } 
            else
            {
                switch (person.eGender)
                {
                    case genderPronoun.them: themRadioButton.Checked = true;
                        break;
                    case genderPronoun.him: himRadioButton.Checked = true;
                        break;
                    case genderPronoun.her: herRadioButton.Checked = true;
                        break;
                }
            }
        ...
        // the Event Handler for changing the class of a student
        //
        ...
        private void TypeComboBox__SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if(cb.SelectedIndex == 0 )
            {
                ...
                // change visibility of class group box to true
            ...
            else
            {
                ...
                // change visibility of class group box to false
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if( this.typeComboBox.SelectedIndex == 0)
            {
                ...
                // set college year for person if they're a student!
