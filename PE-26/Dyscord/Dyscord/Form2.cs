...
namespace Dyscord
{
    ...
    public partial class DyscordForm : Form
    {
        ...
        private void HtmlElement__Click(object sender, HtmlElementEventArgs e)
        {
            ...
            this.targetUser = htmlElement.Name;
        ...
        private void SendButton__Click(object sender, EventArgs e)
        {
            if (targetIp.Length > 0)
            {
                ...
                string msg = userTextBox.Text + ": " + this.messageRichTextBox1.Text;
                ...
                this.convRichTextBox1.Text += "> " + this.targetUser + ": " + this.messageRichTextBox1.Text + "\n";

                this.messageRichTextBox1.Clear();
        ...
        {
            this.convRichTextBox1.Text += text + '\n';
        }
